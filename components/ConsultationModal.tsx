    ...
    <div className="modal" onClick={() => onOpenChange(false)}>
      ...
      >
        <div className="flex items-center justify-between px-6 py-5 border-b">
          <div>
            <div className="font-semibold text-xl">1:1 상담 요청</div>
            <div className="text-xs text-[#C5A46E] tracking-widest mt-0.5">정한일 대표가 직접 답변드립니다</div>
          </div>
        ...
        <div className="p-6">
          <ConsultationForm compact onSuccess={() => setTimeout(() => onOpenChange(false), 1400)} />
        </div>
